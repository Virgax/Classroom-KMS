...
INSERT INTO dbo.HistoryUnitProcess (IMEI, EstacionCodigo, Proceso, CodigoEmpleado, Resultado, ProcesadoEn) VALUES
  (N'350123450000001', N'RXR-01', N'IP68-TEST', N'DR0104', N'PASS', DATEADD(DAY, -20, SYSUTCDATETIME()))
, (N'350123450000002', N'RXR-01', N'IP68-TEST', N'DR0104', N'PASS', DATEADD(DAY, -18, SYSUTCDATETIME()))
, (N'350123450000003', N'RXR-01', N'IP68-TEST', N'DR0104', N'FAIL', DATEADD(DAY, -12, SYSUTCDATETIME()))
, (N'350123450000004', N'RXR-01', N'IP68-TEST', N'DR0104', N'PASS', DATEADD(DAY, -5,  SYSUTCDATETIME()))
, (N'350123450000005', N'RXR-02', N'IP68-TEST', N'DR0105', N'PASS', DATEADD(DAY, -9,  SYSUTCDATETIME()))
, (N'350123450000006', N'IQC-01', N'IQC',       N'DR0108', N'PASS', DATEADD(DAY, -3,  SYSUTCDATETIME()))
, (N'350123450000007', N'FLSH-01',N'FLASH',     N'DR0106', N'PASS', DATEADD(DAY, -2,  SYSUTCDATETIME()));
GO
